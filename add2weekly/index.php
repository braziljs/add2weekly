...
<body>
    ...
    <a title="[BrJS]Sugestão Weekly" alt="[BrJS]Sugestão Weekly" <?php writeJS(); ?>><img src="http://braziljs.org/services/add2weekly/logo-braziljs.png" title="[BrJS]Sugestão Weekly" alt="[BrJS]Sugestão Weekly" style="border: solid 1px blue; "/></a>
